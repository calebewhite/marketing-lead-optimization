...
2. **Feature Engineering:**  
   - Created additional response and total spend features to capture engagement and customer value.  
...
## 📓 Notebook
👉 [View the full Jupyter Notebook](notebooks/2025_Kaggle_Marketing_Optimization.ipynb)
